...
public abstract class MaskTreinoProgressivoPiramide {
    ...
    public static TextWatcher insert(final String mask, final EditText ediTxt, final SemanaTreinoProgressivo smtp) {
