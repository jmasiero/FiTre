 ...
 */
public class FragmentDialogSelecionaAlunoProgramaTreinamento extends DialogFragment {
    ...
    private void iniciaListeners(final View view) {
        lstVwAluno.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                fragmentNovoProgramaTreinamento.setAluno(alunoSelecionado);

                getFragmentManager().beginTransaction()
                        .replace(R.id.container, fragmentNovoProgramaTreinamento, String.valueOf(Constantes.FRAGMENT_NOVO_TREINO_PROGRESSIVO))
        ...
        edtNome.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                lstAlunos = AlunoDAO.getInstance(getContext()).listaFiltradaAlunosSemProgramaTreino(s.toString());
                preencheLista(view);
            }
    ...
    private void listarAlunos(View view) {
        lstAlunos = AlunoDAO.getInstance(getContext()).listaFiltradaAlunosSemProgramaTreino("");
        preencheLista(view);
    }
